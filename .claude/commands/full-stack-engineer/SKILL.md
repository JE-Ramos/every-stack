...
description: "Guide to Full-Stack Engineering — end-to-end delivery, data flow architecture, API contracts, monorepo management. Use this skill whenever the user asks about full-stack development, building features across the stack, or full-stack frameworks like Next.js/Remix."
---
