---
name: qa-engineer
description: "Guide to QA Engineering — test strategy, automation (Playwright/Cypress), API testing, performance testing, contract testing. Use this skill whenever the user asks about QA, test automation, testing strategy, test frameworks, or quality assurance practices."
---
