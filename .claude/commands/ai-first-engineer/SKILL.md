...
- [Claude Code Best Practices](https://code.claude.com/docs/en/best-practices) — Official guide to effective Claude Code usage, context management, and workflow optimization
- [Writing a Good CLAUDE.md](https://claude.com/blog/using-claude-md-files) — How to structure project context files that actually improve AI output
- [Gemini CLI Complete Guide](https://cloud.google.com/blog/topics/developers-practitioners/mastering-gemini-cli-your-complete-guide-from-installation-to-advanced-use-cases) — Installation to advanced use cases for Gemini CLI
- [OpenAI Codex Best Practices](https://developers.openai.com/codex/learn/best-practices/) — Official patterns for effective Codex usage
- [AGENTS.md Guide](https://developers.openai.com/codex/guides/agents-md/) — Structuring durable agent instructions for Codex

### Frameworks & Tools
- [gstack by Garry Tan](https://github.com/garrytan/gstack) — Open-source Claude Code system for planning, code review, QA, and shipping. The reference implementation of role-based AI development
- [GitHub Spec Kit](https://github.blog/ai-and-ml/generative-ai/spec-driven-development-with-ai-get-started-with-a-new-open-source-toolkit/) — Spec-driven development framework: Specify → Plan → Tasks → Implement
- [awesome-claude-code](https://github.com/hesreallyhim/awesome-claude-code) — Curated collection of Claude Code resources, tips, and integrations

### Articles & Workflows
- [My LLM Coding Workflow Going Into 2026 — Addy Osmani](https://addyosmani.com/blog/ai-coding-workflow/) — Senior Staff Engineer at Anthropic shares his complete AI-assisted development workflow
- [How to Write a Good Spec for AI Agents — Addy Osmani](https://addyosmani.com/blog/good-spec/) — The specification-first approach to AI-assisted development
- [Vibe Coding vs AI-Assisted Engineering — Addy Osmani](https://medium.com/@addyosmani/vibe-coding-is-not-the-same-as-ai-assisted-engineering-3f81088d5b98) — Why discipline matters more than speed
- [The Prompt Engineering Playbook for Programmers](https://addyo.substack.com/p/the-prompt-engineering-playbook-for) — Structured prompt patterns for code generation
- [AI Agent Best Practices: 12 Lessons](https://forgecode.dev/blog/ai-agent-best-practices/) — Battle-tested patterns from real AI pair programming
- [Gemini CLI Tips & Tricks — Addy Osmani](https://addyo.substack.com/p/gemini-cli-tips-and-tricks) — Power-user patterns for Gemini CLI

### Deep Dives
- [How Anthropic Teams Use Claude Code (PDF)](https://www-cdn.anthropic.com/58284b19e702b49db9302d5b6f135ad8871e7658.pdf) — Internal practices from the team that builds Claude
- [Understanding Claude Code's Full Stack: MCP, Skills, Subagents, and Hooks](https://alexop.dev/posts/understanding-claude-code-full-stack/) — Deep technical breakdown of Claude Code's architecture
- [Building Consistent Workflows with Codex CLI & Agents SDK](https://cookbook.openai.com/examples/codex/codex_mcp_agents_sdk/building_consistent_workflows_codex_cli_agents_sdk) — MCP + Codex integration patterns

### Career & Industry Context
- [AI Native Dev: Shaping the Future — DevOps.com](https://devops.com/ai-native-dev-shaping-the-future-of-ai-first-software-development/) — What AI-native development means for the industry
- [What Is an AI Native Developer? — The New Stack](https://thenewstack.io/what-is-an-ai-native-developer/) — Defining the AI-native developer role
- [The Next Two Years of Software Engineering — Addy Osmani](https://addyosmani.com/blog/next-two-years/) — Where AI-assisted development is headed
