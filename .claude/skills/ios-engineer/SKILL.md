---
name: ios-engineer
description: "Guide to iOS Native Engineering with SwiftUI — SwiftLint/SwiftFormat/Periphery static analyzers, Swift Concurrency, @Observable, TCA, SwiftData, Xcode Cloud. Use this skill whenever the user asks about iOS development, SwiftUI, Swift, Xcode, Apple platform engineering, or iOS app architecture. Also use when setting up SwiftLint rules or iOS CI/CD pipelines."
