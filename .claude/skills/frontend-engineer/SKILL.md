...
description: "Guide to Frontend Engineering — React/Vue/Svelte, TypeScript, CSS architecture, accessibility, Core Web Vitals. Use this skill whenever the user asks about frontend development, component architecture, web performance, accessibility (WCAG), or design systems."
